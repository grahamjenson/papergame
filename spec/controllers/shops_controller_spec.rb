  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved shop as @shop" do
        ...
        post :create, {:shop => { "retailer_id" => "invalid value" }}, valid_session
        assigns(:shop).should be_a_new(Shop)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested shop" do
        ...
        Shop.any_instance.should_receive(:update_attributes).with({ "retailer_id" => "MyString" })
        put :update, {:id => shop.to_param, :shop => { "retailer_id" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the shop as @shop" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Shop.any_instance.stub(:save).and_return(false)
        put :update, {:id => shop.to_param, :shop => { "retailer_id" => "invalid value" }}, valid_session
        assigns(:shop).should eq(shop)
      end
