  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved trigger as @trigger" do
        ...
        post :create, {:trigger => {  }}, valid_session
        assigns(:trigger).should be_a_new(Trigger)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested trigger" do
        ...
        Trigger.any_instance.should_receive(:update_attributes).with({ "these" => "params" })
        put :update, {:id => trigger.to_param, :trigger => { "these" => "params" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the trigger as @trigger" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Trigger.any_instance.stub(:save).and_return(false)
        put :update, {:id => trigger.to_param, :trigger => {  }}, valid_session
        assigns(:trigger).should eq(trigger)
      end
