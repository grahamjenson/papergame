  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved identifier as @identifier" do
        ...
        post :create, {:identifier => { "identifier_id" => "invalid value" }}, valid_session
        assigns(:identifier).should be_a_new(Identifier)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested identifier" do
        ...
        Identifier.any_instance.should_receive(:update_attributes).with({ "identifier_id" => "MyString" })
        put :update, {:id => identifier.to_param, :identifier => { "identifier_id" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the identifier as @identifier" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Identifier.any_instance.stub(:save).and_return(false)
        put :update, {:id => identifier.to_param, :identifier => { "identifier_id" => "invalid value" }}, valid_session
        assigns(:identifier).should eq(identifier)
      end
