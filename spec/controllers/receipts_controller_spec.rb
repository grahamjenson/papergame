  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved receipt as @receipt" do
        ...
        post :create, {:receipt => { "receipt_id" => "invalid value" }}, valid_session
        assigns(:receipt).should be_a_new(Receipt)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested receipt" do
        ...
        Receipt.any_instance.should_receive(:update_attributes).with({ "receipt_id" => "MyString" })
        put :update, {:id => receipt.to_param, :receipt => { "receipt_id" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the receipt as @receipt" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Receipt.any_instance.stub(:save).and_return(false)
        put :update, {:id => receipt.to_param, :receipt => { "receipt_id" => "invalid value" }}, valid_session
        assigns(:receipt).should eq(receipt)
      end
